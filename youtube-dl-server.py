...
app_defaults = {
    ...
    'YDL_OUTPUT_TEMPLATE': '/Users/jaga/Public/youtube-dl/%(title)s [%(id)s].%(ext)s',
...
def get_ydl_options(request_options):
    ...
    raw_date_range = request_options.get('daterange')
    start, end = raw_date_range.split(" - ")
    date_range = youtube_dl.DateRange(start,end)
